...
int puntos_lanzamientoJ[2];//Son los puntos que se descuenta por cada lanzamiento en la fase final
int puntos_generales[2];//
int puntos_estatuillas[2];
...
int puntos_rivalObtiene[2];//Puntos negativos que obtiene el rival por obtener una estatua.
int nuevoHito_SAC[2];
...
void jugar(){
    ...
    ///Poner vectores en 0
    for(int i=0; i<2; i++){
        puntos_lanzamientoJ[i]=0;
        puntos_generales[i]=0;
        puntos_estatuillas[i]=0;
        puntos_estatuillas_primerIntento[i]=0;
        puntos_ganador_faseFinal[i]=0;
        puntos_ganador_sinEstatuillas[i]=0;
        puntos_rivalObtiene[i]=0;
        nuevoHito_SAC[i]=0;
    }
    ...
    while(true){
        ...
        ///Busca un nuevo HITO de SAC.
        if(cangrejo_J1 && aguilaJ1 && estatuaSalamandra_J1){
            nuevoHito_SAC[empieza]=20;
        }else if (cangrejo_J2 && aguilaJ2 && estatuaSalamandra_J2){
            nuevoHito_SAC[noEmpieza]=20;
        }
        ...
        while(true){
            ...
            if(lanzamiento_j1 == "GANASTE"){
                puntos_ganador_faseFinal[empieza] = 15;
                if(contador_J1 == 0){
            ...
            if(lanzamiento_j2 == "GANASTE"){
                puntos_ganador_faseFinal[noEmpieza] = 15;
                if(contador_J2 == 0){
